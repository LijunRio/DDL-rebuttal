...
Figure 2: The image shows that when faced with true anomaly, the prediction is usually consistent, and DDL will also have a high CSR score; whereas when the first original anchor is wrong, the other peer-evaluation predictions will not stick to the true anomaly, and the CSR will be low.
